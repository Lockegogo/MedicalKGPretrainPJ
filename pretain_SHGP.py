...
def main():
    ...
    def train(target_type, emb):
        ...
        emb[target_type] = embd[target_type]
        return emb

    # # get "PROTEIN" embedding
    # target_embd = embd["PROTEIN"]

    target_types = ["DRUG", "PROTEIN"]
    emb = {}
    for target_type in target_types:
        emb = train(target_type, emb)
...
def save_emb(emb, idx_node_map, idx_node_id_map, epoch, use_linkpred_emb):
    ...
    if use_linkpred_emb:
        ...
        emb_name = "pretrained_emb_dict_SHGP_single_" + str(epoch) + '.pkl'
